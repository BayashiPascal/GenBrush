...
INCPATH=-I./ -I$(PBERRDIR)/ -I$(PBMATHDIR)/ -I$(GSETDIR)/ -I$(SHAPOIDDIR)/ -I$(BCURVEDIR)/
...
main: main.o pberr.o bcurve.o shapoid.o pbmath.o gset.o genbrush.o Makefile 
	$(COMPILER) main.o pberr.o bcurve.o shapoid.o pbmath.o gset.o genbrush.o $(LINKOPTIONS) -o main $(GTKLINK) $(CAIROLINK)
